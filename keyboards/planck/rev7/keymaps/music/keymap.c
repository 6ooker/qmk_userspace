...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, TD(TD_LOS), TD(TD_CPY), KC_LALT, RAISE, KC_RSFT, KC_SPC, LOWER,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  DE_MICR, DE_LBRC, DE_RBRC, DE_PIPE, _______,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  DE_DEG,     DE_LCBR,    DE_RCBR, DE_BSLS, _______,
    _______, _______, _______, _______, _______, _______, _______, _______,    KC_MNXT,    KC_VOLD, KC_VOLU, KC_MPLY
),
