...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [PRIVATE] = LAYOUT_ansi_67(
        ...
        KC_CAPS, DE_A,     DE_S,     DE_D,    DE_F,    DE_G,    DE_H,    DE_J,    DE_K,    DE_L,    DE_SCLN,  DE_QUOT,            KC_ENT,           KC_HOME,
    ...
    [WIN_BASE] = LAYOUT_ansi_67(
        TD(TD_GES),KC_1,   KC_2,     KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     DE_MINS,  DE_EQL,   KC_BSPC,          KC_MUTE,
